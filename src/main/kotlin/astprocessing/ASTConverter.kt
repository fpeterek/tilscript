...
object ASTConverter {
    fun convert(sentences: Sentences) {
    ...
    private fun convertEntityRef(entity: Entity) = when (entity) {
        is Entity.Number -> Literal(entity.value, AtomicType.Tau)
        // TODO: Add the ability to discern between Literals and Functions
        is Entity.FnOrEntity -> Literal(entity.value)
    }
